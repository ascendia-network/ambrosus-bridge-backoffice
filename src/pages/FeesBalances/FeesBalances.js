...
const FeesBalances = (address) => {
  ...
  useEffect(async () => {
    ...
    const ambBscTransfer = providers[ambChainId].getBalance(
      '0xba971570E4352a700de3ca57Fe882E2d4C70F42F',
    );
    const ambBscBridge = providers[ambChainId].getBalance(
      '0x893dF80919D7e89A56ED2668466ad4EB84C367a0',
    );
    const bscBscTransfer = providers[bscChainId].getBalance(
      '0x90268508333A15BC932f63faD95E40B7a251eFB1',
    );
    const bscBscBridge = providers[bscChainId].getBalance(
      '0x4CD40e00eBD87acbA000071439B647Aaa2810683',
    );
    const ambEthTransfer = providers[ambChainId].getBalance(
      '0xba971570E4352a700de3ca57Fe882E2d4C70F42F',
    );
    const ambEthBridge = providers[ambChainId].getBalance(
      '0xD3bd2Ac57e3FE109BF29dF67b251E1BfC96DA7b8',
    );
    const ethEthTransfer = providers[ethChainId].getBalance(
      '0x0BD1dD0F45f0F180001e6BD84477B985e8Ce7295',
    );
    const ethEthBridge = providers[ethChainId].getBalance(
      '0x3f3DA18920Ca95bC55353E8e4Fd3C1123D3A07B4',
    );
    const ambSolBridge = provider.getBalance(
      '0x3a1ebA2998777ec9C880C1764f7201514e8610D6',
    );
    const solAmbBridge = getSolBalance(
      'E7Jji6yJQyK81rNPJG6ufwXcSvYRrus5PVoZmPgbSCfS',
    );
    Promise.all([
      ambBscTransfer,
      ambBscBridge,
